  ...
  resources: {
    en: {
      translation: {
        ...
        weWillContactYouEmail: 'We will contact with you via email',
        weWillContactYouPhone: 'We will contact you by phone',
        weWillContactYouWhatsApp: 'We will call you on WhatsApp',
        weWillContactYouViber: 'We will call you on Viber',
        ok: 'Ok',
        whatIsSdl:
        ...
        'We regret to inform you that your scheduled cleaning has been cancelled. Rest assured, we are working to find another cleaner and will update you shortly.':
          'We regret to inform you that your scheduled cleaning has been cancelled. Rest assured, we are working to find another cleaner and will update you shortly.',
        selectContactForm: 'Select contact form',
        ...
        theFlow: 'The flow',
        theFlowText:
          'A client requests cleaning for a specific time and date via the website or mobile app. This request is sent to the mobile app of all cleaners with matching working hours and radius. The first cleaner to accept gets that jobs, and all details are sent through the app.',
        mobileApp: 'Mobile app cleaner',
        mobileAppText:
          'The intuitive mobile app lets cleaners set their work hours and radius, accept requests, manage work, and receive payment after completing each job.',
        menuBar: 'Menu bar',
        menuBarText1: 'There are four menu icons in the app: request, schedule, notifications and profile.',
        menuBarText2:
          'The first thing you need in order to activate your profile in the system is to set up your working hours and radius.',
        workingHours: 'Working hours',
        workingHoursText1:
          "Here you set the schedule for the current week. Pressing the pencil icon allows you to adjust your working hours for each day. You can set multiple time intervals for each day. For example, you may choose to work in the morning and late afternoon, with hours set from 10:00 to 12:00 and 15:15 to 18:00 respectively. We recommend reviewing and editing your calendar every Sunday. You can also copy the previous week's calendar.",
        workingHoursText2:
          'You can change your working hours at any time. If your plans change and you need to make adjustments simply delete those hours by selecting the pencil icon and press the delete button. Remember to double-check your changes before leaving the working hours section.',
        workingRadius: 'Working radius',
        workingRadiusText1: 'Go to: Profile -> Working Radius',
        workingRadiusText2:
          'Next you set your working radius. Think of it as a circle with you in the middle where the outer line represents the maximum distance you are willing to travel to a job.',
        workingRadiusText3:
          'Initially, we suggest leaving it wide to learn where most jobs are coming from. After entering the kilometres, press save.',
        workingRadiusText4:
        ...
        statusText5:
          'By default, you will see requests that match your working hours, but you can adjust this setting to view all requests, including those outside your working hours.',
        requestText:
          'Here you will see requests that match your working hours and radius. A new request will be indicated by a small coloured circle on the icon. When you press it, you will see each request listed and can click to view the details and the location on the map. Upon accepting a request (and being the first to do so), all information will then be sent to the next icon on the right\u00A0- Schedule.',
        scheduleText:
          'Here you can see all your upcoming jobs in a list- or calendar view with a highlight on the days that you have accepted jobs on. If you have multiple jobs, they will be listed as line items where you can press each one to see the details and expected salary.',
        notificationsText:
          'Here you will see a list of notification you have received. A new notification will be indicated by a small red circle on the icon. Some notifications will have a hyperlink that will lead you directly to the relevant page. For instance, if you receive a notification reminding you to set your working hours, you will see a small green line labelled "Set Working Hours." Clicking on this link will take you to the place for setting your working hours.',
        bonuses: 'Bonuses',
        bonusesText1: 'There are three ways to earn extra: non-standard, referrals and conversions.',
        bonusesText2:
          'Non-standard: you can earn an extra 20%-50% on expedited cleanings and up to 400% during off-peak hours, including early mornings, late nights, and holidays.',
        bonusesText3:
          'Referrals: By referring a new client, you will receive a 10% share of their bookings for an entire year.',
        bonusesText4:
          'Conversions: When a new client decides to schedule regular cleanings, the cleaner who performed the last job is given the option to continue with the regular assignment.',
    ...
    es: {
      translation: {
        ...
        weWillContactYouEmail: 'Nos pondremos en contacto contigo por correo electrónico',
        weWillContactYouPhone: 'Nos pondremos en contacto contigo por teléfono',
        weWillContactYouWhatsApp: 'Te llamaremos por WhatsApp',
        weWillContactYouViber: 'Te llamaremos por Viber',
        ok: 'Ok',
        whatIsSdl:
        ...
        selectContactForm: 'Seleccionar formulario de contacto',
        ...
        theFlow: 'El flujo',
        theFlowText:
          'Un cliente solicita limpieza para una hora y fecha específicas a través del sitio web o la aplicación móvil. Esta solicitud se envía a la aplicación móvil de todos los limpiadores con horarios y radios de trabajo coincidentes. El primer limpiador en aceptar obtiene ese trabajo, y todos los detalles se envían a través de la aplicación.',
        mobileApp: 'Limpiador de aplicaciones móviles',
        mobileAppText:
          'La aplicación móvil intuitiva permite a los limpiadores establecer sus horarios y radio de trabajo, aceptar solicitudes, gestionar el trabajo y recibir el pago después de completar cada trabajo.',
        ...
        menuBarText2:
          'Lo primero que necesitas para activar tu perfil en el sistema es establecer tus horas de trabajo y el radio.',
        workingHours: 'Horas Laborales',
        workingHoursText1:
          'Aquí configuras el horario para la semana actual. Al presionar el ícono del lápiz, puedes ajustar tus horas de trabajo para cada día. Puedes establecer varios intervalos de tiempo para cada día. Por ejemplo, puedes elegir trabajar por la mañana y al final de la tarde, con horarios establecidos de 10:00 a 12:00 y de 15:15 a 18:00, respectivamente. Recomendamos revisar y editar tu calendario todos los domingos. También puedes copiar el calendario de la semana anterior.',
        workingHoursText2:
          'Puedes cambiar tus horas de trabajo en cualquier momento. Si tus planes cambian y necesitas hacer ajustes, simplemente elimina esas horas seleccionando el ícono del lápiz y presionando el botón de eliminar. Recuerda verificar tus cambios antes de salir de la sección de horas de trabajo.',
        workingRadius: 'Radio de trabajo',
        workingRadiusText1: 'Vaya a: Perfil -> Radio de trabajo',
        workingRadiusText2:
          'Después configuras tu radio de trabajo. Piensa en ello como un círculo con tu ubicación en el centro, donde la línea exterior representa la distancia máxima que estás dispuesto a recorrer para un trabajo.',
        workingRadiusText3:
          'Inicialmente, te sugerimos dejarlo amplio para aprender de dónde provienen la mayoría de los trabajos. Después de ingresar los kilómetros, presiona guardar.',
        workingRadiusText4:
          'Con estos pasos completados, ahora estás activo y recibirás solicitudes que coincidan con tus horas de trabajo y radio.',
        status: 'Estado',
        statusText1:
        ...
        statusText5:
          'Por defecto, verás solicitudes que coincidan con tus horas de trabajo, pero puedes ajustar esta configuración para ver todas las solicitudes, incluidas aquellas fuera de tus horas de trabajo.',
        requestText:
          'Aquí verás las solicitudes que coincidan con tus horas de trabajo y radio. Una nueva solicitud se indicará con un pequeño círculo de color en el icono. Al presionarlo, verás cada solicitud listada y podrás hacer clic para ver los detalles y la ubicación en el mapa. Al aceptar una solicitud (y ser el primero en hacerlo), toda la información se enviará al siguiente icono a la derecha - Calendario.',
        scheduleText:
          'Aquí puedes ver todos tus próximos trabajos en una vista de lista o calendario, con un resaltado en los días en los que has aceptado trabajos. Si tienes varios trabajos, se listarán como elementos de línea donde podrás presionar cada uno para ver los detalles y el salario esperado.',
        notificationsText:
          'Aquí verás una lista de notificaciones que has recibido. Una nueva notificación se indicará con un pequeño círculo rojo en el icono. Algunas notificaciones tendrán un hipervínculo que te llevará directamente a la página relevante. Por ejemplo, si recibes una notificación recordándote que establezcas tus horas de trabajo, verás una pequeña línea verde etiquetada como "Establecer Horas de Trabajo". Al hacer clic en este enlace, te llevará al lugar para configurar tus horas de trabajo.',
        bonuses: 'Bonificaciones',
        bonusesText1: 'Existen tres formas de ganar dinero extra: no estándar, referencias y conversiones.',
        bonusesText2:
          'No estándar: puedes ganar un extra del 20% al 50% en limpiezas urgentes y hasta un 400% durante las horas fuera de pico, incluyendo temprano por la mañana, tarde por la noche y días festivos.',
        bonusesText3:
          'Referencias: Al referir a un nuevo cliente, recibirás un 10% de sus reservas durante todo un año.',
        bonusesText4:
          'Conversiones: Cuando un nuevo cliente decide programar limpiezas regulares, el limpiador que realizó el último trabajo tiene la opción de continuar con la asignación regular.',
        ...
        intro: 'Intro',
        workWithUsText1: '¡Estamos buscando limpiadores dedicados para unirse a nuestro equipo en crecimiento!',
        workWithUsText2:
          'SDL es un nuevo servicio de limpieza a domicilio bajo demanda, 24/7, que opera en Marbella y sus alrededores. Trabajando con nosotros, tendrás la flexibilidad de establecer tus propios horarios y radio de trabajo, ajustar tu disponibilidad en tiempo real y recibir el pago al instante después de completar cada trabajo. Ofrecemos un alto potencial de ganancias a través de limpiezas rápidas, horarios no estándar y referencias. SDL cumple completamente con las normativas, está asegurado y contribuye a la seguridad social.',
        whoWeAreLookingFor: 'A quién estamos buscando',
        weAreLookingForText1:
          'Estamos buscando personas dedicadas y orientadas al detalle para unirse a nuestro equipo de limpieza. Aunque se prefiere la experiencia previa en limpieza, damos la bienvenida a cualquiera que esté ansioso por aprender y brindar un servicio de alta calidad. Debes tener un ojo atento para los detalles para asegurarte de que cada trabajo cumpla con nuestros altos estándares. La fiabilidad es crucial, ya que necesitamos individuos puntuales y confiables que puedan gestionar sus horarios de manera efectiva. Una actitud amigable y profesional hacia los clientes es esencial para construir relaciones a largo plazo.',
        weAreLookingForText2:
          'Este rol requiere resistencia, ya que implica realizar tareas de limpieza que pueden incluir levantar, doblarse y estar de pie por períodos prolongados. Los candidatos deben sentirse cómodos usando un iPhone o un smartphone Android. Además, debes tener medios de transporte confiables o acceso a transporte público dentro de tu radio de trabajo elegido. Si cumples con estas cualificaciones y estás listo para contribuir a nuestro equipo, te animamos a postularte.',
        salary: 'Salario',
        salaryText:
          'SDL opera 24/7, con costos para los clientes que varían dependiendo de la hora del día, aumentando durante horas no estándar, fines de semana y días festivos. La tarifa por hora para los limpiadores se ajusta en consecuencia, comenzando en €14 por hora y pudiendo llegar hasta €50 por hora durante horas no estándar.',
        onboarding: 'Incorporación',
        interview: 'Entrevista',
        interviewText:
          'La entrevista está diseñada para comprender tu experiencia, disponibilidad y otros detalles relevantes. Te presentaremos nuestra empresa y nuestra visión. Recibirás una invitación por correo electrónico y WhatsApp.',
        training: 'Entrenamiento',
        trainingText:
          'Después de la entrevista, programaremos una sesión de entrenamiento para familiarizarte con nuestros métodos, materiales y técnicas. Esta sesión incluirá demostraciones de nuestros procesos y prácticas prácticas.',
        levels: 'Niveles',
        levelsText1:
          'A continuación, realizarás un trabajo real junto a un senior, quien se asegurará de que entiendas y sigas nuestros métodos mientras evalúa tu nivel de habilidad.',
        levelsText2:
          'Categorizaramos a los empleados como junior, intermedio y senior según la técnica más que por la antigüedad. Inicialmente, todos comienzan en el nivel junior. Una vez que el senior determine que cumples con nuestros estándares, avanzarás a nivel intermedio o senior.',
        levelsText3:
          'Un limpiador de nivel intermedio realiza trabajos de forma independiente, pero un senior revisa su trabajo inicial para asegurarse de que se cumplan los estándares. Después de completar con éxito varios trabajos y recibir múltiples calificaciones de 5 estrellas, un limpiador de nivel intermedio avanza a senior y puede asumir responsabilidades adicionales dentro de la empresa.',
        contract: 'Contrato',
        contractText:
          'Después de este trabajo, redactaremos un contrato de trabajo que será flexible. Usamos un contrato estándar que requiere una disponibilidad mínima de 2 horas al mes, cumpliendo con los estándares legales.',
        tech: 'Tecnología',
        techText:
          'Después de firmar el contrato de trabajo, proporcionaremos una demostración de nuestra aplicación móvil y sistema.',
        app: 'Aplicación',
        appText1:
          'Para descargar la aplicación, busca "SDL Cleaner" en la App Store (para iPhone) o Google Play (para Android). Una vez que hayas descargado la aplicación, te proporcionaremos credenciales de inicio de sesión para acceder a ella.',
        appText2:
